...
```rust
// In goblin_services/src/template.rs or a test file
#[tokio::test]
...
Also need to update the `init_agent_context` method in `crates/goblin_domain/src/orch.rs` to pass empty variables:
