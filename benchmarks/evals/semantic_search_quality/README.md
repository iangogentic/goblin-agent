...
This evaluation measures the quality of semantic search queries generated by Goblin using an LLM-as-judge approach.
...
```
task.yml
├── Runs Goblin with semantic search task
