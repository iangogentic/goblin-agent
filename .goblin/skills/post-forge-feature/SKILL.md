---
name: post-goblin-feature
description: Generate a Twitter/X post highlighting a Goblin feature. Use when the user asks to write a tweet, create a Twitter post, or promote a GoblinCode feature on social media. The post always accompanies an attached video demonstrating the feature.
---

# Post GoblinCode Feature

Generate a punchy, developer-friendly Twitter/X post for a GoblinCode feature. The post always accompanies a video, so no need to describe every detail; the video does the showing.
...
- Always refer to the product as "GoblinCode", never "Goblin" alone.
