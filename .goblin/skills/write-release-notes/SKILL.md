...
```bash
bash .goblin/skills/write-release-notes/scripts/fetch-release-data.sh <version> [owner/repo]
```
...
```bash
echo "<release notes>" | bash .goblin/skills/write-release-notes/scripts/validate-release-notes.sh
```
