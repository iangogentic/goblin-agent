...
```bash
.goblin/skills/resolve-conflicts/scripts/handle-deleted-modified.sh
```
...
```bash
.goblin/skills/resolve-conflicts/scripts/validate-conflicts.sh
```
...
Co-Authored-By: GoblinCode <noreply@goblincode.dev>"
```
