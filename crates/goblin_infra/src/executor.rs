...
use goblin_app::CommandInfra;
use goblin_domain::{CommandOutput, ConsoleWriter as OutputPrinterTrait, Environment};
...
#[derive(Clone, Debug)]
pub struct GoblinCommandExecutorService {
    env: Environment,
...
impl GoblinCommandExecutorService {
...
impl CommandInfra for GoblinCommandExecutorService {
...
mod tests {
    ...
    async fn test_command_executor() {
        let fixture = GoblinCommandExecutorService::new(test_env(), test_printer());
