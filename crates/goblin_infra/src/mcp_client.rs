...
use goblin_app::McpClientInfra;
use goblin_domain::{Image, McpHttpServer, McpServerConfig, ToolDefinition, ToolName, ToolOutput};
...
impl McpClientInfra for GoblinMcpClient {
    async fn list(&self) -> anyhow::Result<Vec<ToolDefinition>> {
