...
/// Checks if the Goblin VS Code extension is installed
///
/// Checks VS Code's extension list to see if GoblinCode.goblin-vscode is
/// installed.
pub fn is_extension_installed() -> bool {
        ...
        && let Ok(extensions) = String::from_utf8(output.stdout)
    {
        return extensions
            .lines()
            .any(|line| line.trim() == "GoblinCode.goblin-vscode");
    }
    false
}

/// Attempts to install the Goblin VS Code extension silently
///
