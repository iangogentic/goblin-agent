...
use goblin_api::{AgentId, ModelId, Usage};
...
mod tests {
    ...
    fn test_render_prompt_right_with_usage() {
        let usage = Usage {
            prompt_tokens: goblin_api::TokenCount::Actual(10),
            completion_tokens: goblin_api::TokenCount::Actual(20),
            total_tokens: goblin_api::TokenCount::Approx(30),
            ..Default::default()
        };
        let mut prompt = GoblinPrompt::default();
    ...
    fn test_render_prompt_right_with_model() {
        let usage = Usage {
            prompt_tokens: goblin_api::TokenCount::Actual(10),
            completion_tokens: goblin_api::TokenCount::Actual(20),
            total_tokens: goblin_api::TokenCount::Actual(30),
            ..Default::default()
        };
        let mut prompt = GoblinPrompt::default();
        let _ = prompt.usage(usage);
