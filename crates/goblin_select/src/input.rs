...
mod tests {
    ...
    fn test_input_builder_creates() {
        let builder = GoblinWidget::input("Enter name");
    ...
    fn test_input_builder_with_default() {
        let builder = GoblinWidget::input("Enter key").with_default("mykey");
        assert_eq!(builder.default, Some("mykey".to_string()));
    }

    #[test]
    fn test_input_builder_allow_empty() {
        let builder = GoblinWidget::input("Enter").allow_empty(true);
