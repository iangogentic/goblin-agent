...
/// plugin's `_goblin_fzf` wrapper for a consistent UI.
///
...
/// `--color=dark,header:bold` mirror the shell plugin's `_goblin_fzf` wrapper
...
mod tests {
    ...
    use super::*;
    use crate::GoblinWidget;

    #[test]
    fn test_select_builder_creates() {
        let builder = GoblinWidget::select("Test", vec!["a", "b", "c"]);
    ...
    fn test_confirm_builder_creates() {
        let builder = GoblinWidget::confirm("Confirm?");
    ...
    fn test_select_builder_with_initial_text() {
        let builder =
            GoblinWidget::select("Test", vec!["apple", "banana", "cherry"]).with_initial_text("app");
    ...
    fn test_select_owned_builder_with_initial_text() {
        let builder =
            GoblinWidget::select("Test", vec!["apple", "banana", "cherry"]).with_initial_text("ban");
    ...
    fn test_with_starting_cursor() {
        let builder = GoblinWidget::select("Test", vec!["a", "b", "c"]).with_starting_cursor(2);
