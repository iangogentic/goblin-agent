...
use goblin_app::{HttpResponse, NetFetchService, ResponseContext, is_binary_content_type};
...
#[derive(Debug)]
pub struct GoblinFetch {
    client: Client,
}

impl Default for GoblinFetch {
    fn default() -> Self {
        Self::new()
    }
}
...
impl NetFetchService for GoblinFetch {
