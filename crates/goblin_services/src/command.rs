...
impl<F: FileReaderInfra + FileWriterInfra + FileInfoInfra + EnvironmentInfra + DirectoryReaderInfra>
    goblin_app::CommandLoaderService for CommandLoaderService<F>
{
...
mod tests {
    ...
    async fn test_parse_basic_command() {
        let content = goblin_test_kit::fixture!("src/fixtures/commands/basic.md").await;
    ...
    async fn test_parse_command_with_multiline_prompt() {
        let content = goblin_test_kit::fixture!("src/fixtures/commands/multiline.md").await;
    ...
    async fn test_parse_invalid_frontmatter() {
        let content = goblin_test_kit::fixture!("src/fixtures/commands/invalid.md").await;
    ...
    async fn test_parse_builtin_commands() {
        ...
        let builtin_commands = [
            ("fixme", "../../.goblin/commands/fixme.md"),
            ("check", "../../.goblin/commands/check.md"),
        ];

        for (name, path) in builtin_commands {
            let content = goblin_test_kit::fixture!(path).await;
