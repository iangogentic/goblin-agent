...
use goblin_app::{AuthService, EnvironmentInfra, HttpInfra, User, UserUsage};
use reqwest::Url;
...
pub struct GoblinAuthService<I> {
    infra: Arc<I>,
}

impl<I: HttpInfra + EnvironmentInfra> GoblinAuthService<I> {
...
impl<I: HttpInfra + EnvironmentInfra> AuthService for GoblinAuthService<I> {
    async fn user_info(&self, api_key: &str) -> anyhow::Result<User> {
