...
use goblin_app::{CommandInfra, CustomInstructionsService, EnvironmentInfra, FileReaderInfra};
...
#[derive(Clone)]
pub struct GoblinCustomInstructionsService<F> {
    infra: Arc<F>,
    cache: tokio::sync::OnceCell<Vec<String>>,
}

impl<F: EnvironmentInfra + FileReaderInfra + CommandInfra> GoblinCustomInstructionsService<F> {
...
impl<F: EnvironmentInfra + FileReaderInfra + CommandInfra> CustomInstructionsService
    for GoblinCustomInstructionsService<F>
{
