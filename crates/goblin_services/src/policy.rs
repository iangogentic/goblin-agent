...
#[derive(Clone)]
pub struct GoblinPolicyService<I> {
    infra: Arc<I>,
}
    ...
    I: FileReaderInfra + FileWriterInfra + FileInfoInfra + EnvironmentInfra + DirectoryReaderInfra,
{
    ...
    /// Load all policy definitions from the goblin/policies directory
...
impl<I> PolicyService for GoblinPolicyService<I>
where
    I: FileReaderInfra
        + FileWriterInfra
        + FileInfoInfra
