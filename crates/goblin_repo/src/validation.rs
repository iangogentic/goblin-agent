...
use goblin_domain::{SyntaxError, ValidationRepository};
...
pub struct GoblinValidationRepository<I> {
    infra: Arc<I>,
}

impl<I> GoblinValidationRepository<I> {
...
#[async_trait]
impl<I: GrpcInfra> ValidationRepository for GoblinValidationRepository<I> {
