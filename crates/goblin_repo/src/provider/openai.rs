...
use goblin_app::dto::openai::{ListModelResponse, ProviderPipeline, Request, Response};
use goblin_config::RetryConfig;
use goblin_domain::{ChatRepository, Provider};
...
impl<H: HttpInfra> OpenAIProvider<H> {
    ...
    async fn inner_models(&self) -> Result<Vec<goblin_app::domain::Model>> {
    ...
    fn inner_vertex_models(&self) -> Vec<goblin_app::domain::Model> {
        static VERTEX_MODELS: LazyLock<Vec<goblin_app::domain::Model>> = LazyLock::new(|| {
...
impl<T: HttpInfra> OpenAIProvider<T> {
    ...
    pub async fn models(&self) -> Result<Vec<goblin_app::domain::Model>> {
...
mod tests {
    ...
    use bytes::Bytes;
    use goblin_app::HttpInfra;
    use goblin_app::domain::{Provider, ProviderId, ProviderResponse};
    ...
    fn openai(key: &str) -> Provider<Url> {
        Provider {
            ...
            url_params: vec![],
            models: Some(goblin_domain::ModelSource::Url(
