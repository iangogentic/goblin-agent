use goblin_app::domain::Error as DomainError;
use goblin_app::dto::anthropic::Error as AnthropicError;
use goblin_app::dto::openai::{Error, ErrorResponse};
...
mod tests {
    use anyhow::anyhow;
    use goblin_app::dto::openai::{Error, ErrorCode, ErrorResponse};
