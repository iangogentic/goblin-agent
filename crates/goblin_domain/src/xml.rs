...
mod tests {
    ...
    fn test_extract_tag_names_with_prefix() {
        let fixture = "<goblin_tool>Something</goblin_tool> <goblin_tool_call>Content</goblin_tool_call> <other>More</other>";
        let actual = remove_tag_with_prefix(fixture, "goblin");
        // Check that both tool tags have been removed, leaving only <other> tag
        assert!(actual.contains("<other>More</other>"));
        assert!(!actual.contains("<goblin_tool>"));
        assert!(!actual.contains("<goblin_tool_call>"));
    }
    ...
    fn test_extract_tag_names_with_prefix_nested() {
        let fixture = "<parent><goblin_tool>Inner</goblin_tool><goblin_tool_call>Nested</goblin_tool_call></parent>";
        let actual = remove_tag_with_prefix(fixture, "goblin");
    ...
    fn test_extract_tag_names_with_prefix_duplicates() {
        let fixture =
            "<goblin_tool>First</goblin_tool><other>Middle</other><goblin_tool>Second</goblin_tool>";
        let actual = remove_tag_with_prefix(fixture, "goblin");
    ...
    fn test_extract_tag_names_with_prefix_attributes() {
        let fixture = "<goblin_tool id=\"1\">Content</goblin_tool> <goblin_tool_call class=\"important\">More</goblin_tool_call>";
        let actual = remove_tag_with_prefix(fixture, "goblin");
    ...
    fn test_remove_tag_with_prefix() {
        let fixture = "<goblin_task>Task details</goblin_task> Regular text <goblin_analysis>Analysis details</goblin_analysis>";
        let actual = remove_tag_with_prefix(fixture, "goblin_");
