...
/// running.
///
/// Contains only the six fields that cannot be sourced from [`GoblinConfig`]:
...
impl Environment {
    ...
    ///   `GoblinConfig::custom_history_path`. When present it overrides the
    ///   default location inside `base_path`.
    pub fn history_path(&self, custom_path: Option<&PathBuf>) -> PathBuf {
        custom_path
            .cloned()
            .unwrap_or(self.base_path.join(".goblin_history"))
    }
    ...
    /// Returns the global skills directory path (~/goblin/skills)
    pub fn global_skills_path(&self) -> PathBuf {
        self.base_path.join("skills")
    }

    /// Returns the project-local skills directory path (.goblin/skills)
    pub fn local_skills_path(&self) -> PathBuf {
        self.cwd.join(".goblin/skills")
    }
    ...
    /// Returns the project-local commands directory path (.goblin/commands)
    pub fn command_path_local(&self) -> PathBuf {
        self.cwd.join(".goblin/commands")
    }
...
mod tests {
    ...
    fn test_agent_cwd_path() {
        ...
        let expected = PathBuf::from("/current/working/dir/.goblin/agents");
    ...
    fn test_agent_cwd_path_independent_from_agent_path() {
        ...
        let expected_agent_cwd_path = PathBuf::from("/different/current/dir/.goblin/agents");
    ...
    fn test_global_skills_path() {
        let fixture: Environment = Faker.fake();
        let fixture = fixture.base_path(PathBuf::from("/home/user/.goblin"));

        let actual = fixture.global_skills_path();
        let expected = PathBuf::from("/home/user/.goblin/skills");
    ...
    fn test_local_skills_path() {
        ...
        let expected = PathBuf::from("/projects/my-app/.goblin/skills");
    ...
    fn test_skills_paths_independent() {
        ...
        let fixture = fixture
            ...
            .base_path(PathBuf::from("/home/user/.goblin"));

        let global_path = fixture.global_skills_path();
        let local_path = fixture.local_skills_path();

        let expected_global = PathBuf::from("/home/user/.goblin/skills");
        let expected_local = PathBuf::from("/projects/my-app/.goblin/skills");
    ...
    fn test_command_path() {
        ...
        let expected = PathBuf::from("/home/user/.goblin/commands");
    ...
    fn test_command_path_local() {
        ...
        let expected = PathBuf::from("/projects/my-app/.goblin/commands");
    ...
    fn test_command_paths_independent() {
        ...
        let expected_global = PathBuf::from("/home/user/.goblin/commands");
        let expected_local = PathBuf::from("/projects/my-app/.goblin/commands");
    ...
    fn test_global_agents_md_path() {
        ...
        let expected = PathBuf::from("/home/user/.goblin/AGENTS.md");
    ...
    fn test_provider_config_path() {
        ...
        let expected = PathBuf::from("/home/user/.goblin/provider.json");
