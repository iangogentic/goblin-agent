...
/// # Example
/// ```
/// use goblin_domain::{HttpConfig, TlsVersion, TlsBackend};
///
...
/// - `GOBLIN_HTTP_MIN_TLS_VERSION`: Set minimum TLS version (e.g., "1.2")
/// - `GOBLIN_HTTP_MAX_TLS_VERSION`: Set maximum TLS version (e.g., "1.3")
...
/// - `GOBLIN_HTTP_CONNECT_TIMEOUT`: Connection timeout in seconds (default: 30)
/// - `GOBLIN_HTTP_READ_TIMEOUT`: Read timeout in seconds (default: 900)
/// - `GOBLIN_HTTP_POOL_IDLE_TIMEOUT`: Pool idle timeout in seconds (default: 90)
/// - `GOBLIN_HTTP_POOL_MAX_IDLE_PER_HOST`: Max idle connections per host
///   (default: 5)
/// - `GOBLIN_HTTP_MAX_REDIRECTS`: Maximum redirects to follow (default: 10)
/// - `GOBLIN_HTTP_USE_HICKORY`: Use Hickory DNS resolver (default: false)
/// - `GOBLIN_HTTP_TLS_BACKEND`: TLS backend ("default" or "rustls", default:
///   "default")
/// - `GOBLIN_HTTP_MIN_TLS_VERSION`: Minimum TLS version ("1.0", "1.1", "1.2",
///   "1.3")
/// - `GOBLIN_HTTP_MAX_TLS_VERSION`: Maximum TLS version ("1.0", "1.1", "1.2",
///   "1.3")
/// - `GOBLIN_HTTP_ADAPTIVE_WINDOW`: Enable HTTP/2 adaptive window (default:
///   true)
/// - `GOBLIN_HTTP_KEEP_ALIVE_INTERVAL`: Keep-alive interval in seconds (default:
///   60, use "none"/"disabled" to disable)
/// - `GOBLIN_HTTP_KEEP_ALIVE_TIMEOUT`: Keep-alive timeout in seconds (default:
///   10)
/// - `GOBLIN_HTTP_KEEP_ALIVE_WHILE_IDLE`: Keep-alive while idle (default: true)
/// - `GOBLIN_HTTP_ACCEPT_INVALID_CERTS`: Accept invalid certificates (default:
///   false) - USE WITH CAUTION
/// - `GOBLIN_HTTP_ROOT_CERT_PATHS`: Paths to root certificate files (PEM, CRT,
