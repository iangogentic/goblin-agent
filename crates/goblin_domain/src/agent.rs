...
impl AgentId {
    ...
    pub const GOBLIN: AgentId = AgentId(Cow::Borrowed("goblin"));
    pub const IMP: AgentId = AgentId(Cow::Borrowed("imp"));
    pub const WISP: AgentId = AgentId(Cow::Borrowed("wisp"));
}
...
pub struct ReasoningConfig {
    ...
    /// supported by openrouter and goblin provider
    #[serde(skip_serializing_if = "Option::is_none")]
    pub effort: Option<Effort>,

    /// Controls how many tokens the model can spend thinking.
    /// supported by openrouter, anthropic and goblin provider
