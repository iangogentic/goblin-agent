...
use goblin_tool_macros::ToolDescription;
...
#[tool_description_file = "crates/goblin_domain/src/tools/descriptions/fs_read.md"]
pub struct FSRead {
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/goblin_domain/src/tools/descriptions/fs_write.md"]
pub struct FSWrite {
...
#[tool_description_file = "crates/goblin_domain/src/tools/descriptions/fs_search.md"]
#[derive(Default)]
pub struct FSSearch {
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/goblin_domain/src/tools/descriptions/semantic_search.md"]
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/goblin_domain/src/tools/descriptions/fs_remove.md"]
pub struct FSRemove {
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/goblin_domain/src/tools/descriptions/fs_patch.md"]
pub struct FSPatch {
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/goblin_domain/src/tools/descriptions/fs_undo.md"]
pub struct FSUndo {
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/goblin_domain/src/tools/descriptions/shell.md"]
pub struct Shell {
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/goblin_domain/src/tools/descriptions/net_fetch.md"]
pub struct NetFetch {
    /// URL to fetch
    pub url: String,
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/goblin_domain/src/tools/descriptions/followup.md"]
pub struct Followup {
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/goblin_domain/src/tools/descriptions/plan_create.md"]
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/goblin_domain/src/tools/descriptions/skill_fetch.md"]
...
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, ToolDescription, PartialEq)]
#[tool_description_file = "crates/goblin_domain/src/tools/descriptions/todo_write.md"]
...
pub struct UndoInput {
    ...
    /// a Goblin file operation. If the file was deleted, provide the
...
static GOBLIN_TOOLS: LazyLock<HashSet<ToolName>> =
...
static GOBLIN_TOOLS_LOWER: LazyLock<HashMap<String, ToolName>> = LazyLock::new(|| {
    ToolCatalog::iter()
        .map(|tool| {
...
impl ToolCatalog {
    ...
    pub fn contains(tool_name: &ToolName) -> bool {
        ...
        GOBLIN_TOOLS.contains(&normalized)
    }
    ...
    fn try_from(value: ToolCallFull) -> Result<Self, Self::Error> {
        ...
        let coerced_args = ToolCatalog::iter()
            ...
            .map(|tool| {
                ...
                goblin_json_repair::coerce_to_schema(parsed_args.clone(), &schema)
            })
...
impl ToolKind {
    ...
    pub fn definition(&self) -> ToolDefinition {
        ToolCatalog::iter()
            ...
            .expect("Goblin tool definition not found")
    }
}
