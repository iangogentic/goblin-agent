...
mod tests {
    ...
    fn create_conversation_with_messages(messages: Vec<TextMessage>) -> Conversation {
        ...
        Conversation {
            ...
            metadata: goblin_domain::MetaData::new(chrono::Utc::now()),
        }
    }
    ...
    fn test_doom_loop_detector_real_world_scenario() {
        ...
        let diagnostics_call = ToolCallFull::new("mcp_goblin_extension_tool_get_diagnostics")
