use goblin_domain::{DefaultTransformation, Provider, ProviderId, Transformer};
use url::Url;
...
mod tests {
    ...
    fn goblin(key: &str) -> Provider<Url> {
        Provider {
            ...
            url_params: vec![],
            credential: make_credential(ProviderId::GOBLIN, key),
            custom_headers: None,
    ...
    fn test_supports_open_router_params() {
        assert!(supports_open_router_params(&goblin("goblin")));
    ...
    fn test_zai_provider_applies_thinking_transformation() {
        ...
        let fixture = Request::default().reasoning(goblin_domain::ReasoningConfig {
            enabled: Some(true),
            effort: None,
            max_tokens: None,
            exclude: None,
    ...
    fn test_openai_provider_trims_tool_call_ids() {
        ...
        let fixture = Request::default().messages(vec![crate::dto::openai::Message {
            ...
            content: None,
            name: None,
            tool_call_id: Some(goblin_domain::ToolCallId::new(long_id)),
            tool_calls: None,
