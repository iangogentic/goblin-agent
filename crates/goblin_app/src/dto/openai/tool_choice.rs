...
impl From<goblin_domain::ToolChoice> for ToolChoice {
    fn from(value: goblin_domain::ToolChoice) -> Self {
        match value {
            goblin_domain::ToolChoice::None => ToolChoice::None,
            goblin_domain::ToolChoice::Auto => ToolChoice::Auto,
            goblin_domain::ToolChoice::Required => ToolChoice::Required,
            goblin_domain::ToolChoice::Call(tool_name) => ToolChoice::Function {
