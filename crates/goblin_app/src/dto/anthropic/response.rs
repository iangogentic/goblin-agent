...
impl From<Model> for goblin_domain::Model {
    fn from(value: Model) -> Self {
        ...
        {
            vec![
                goblin_domain::InputModality::Text,
                goblin_domain::InputModality::Image,
            ]
        } else {
            vec![goblin_domain::InputModality::Text]
        };
...
impl From<Usage> for goblin_domain::Usage {
...
impl From<StopReason> for goblin_domain::FinishReason {
    fn from(value: StopReason) -> Self {
        match value {
            StopReason::EndTurn => goblin_domain::FinishReason::Stop,
            StopReason::MaxTokens => goblin_domain::FinishReason::Length,
            StopReason::StopSequence => goblin_domain::FinishReason::Stop,
            StopReason::ToolUse => goblin_domain::FinishReason::ToolCalls,
        }
    }
}
    ...
    fn try_from(value: Event) -> Result<Self, Self::Error> {
        let result = match value {
            ...
            Event::Ping { cost: Some(cost) } => {
                ...
                ChatCompletionMessage::assistant(Content::part(""))
                    .usage(goblin_domain::Usage { cost: Some(cost_value), ..Default::default() })
            }
...
mod tests {
    ...
    fn test_usage_conversion_with_cache_read_tokens() {
        ...
        let actual: goblin_domain::Usage = fixture.into();
    ...
    fn test_vertex_ai_streaming_usage() {
        ...
        let initial_domain: goblin_domain::Usage = initial_usage.into();
        let delta_domain: goblin_domain::Usage = delta_usage.into();
    ...
    fn test_model_conversion_includes_context_length() {
        ...
        let actual: goblin_domain::Model = fixture.into();
    ...
    fn test_ping_event_with_cost_produces_usage() {
        ...
        let expected_usage = goblin_domain::Usage { cost: Some(0.00724710), ..Default::default() };
