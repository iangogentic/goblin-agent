...
use goblin_domain::{FileHash, FileNode, FileStatus, SyncProgress, SyncStatus};
    ...
    fn test_file_statuses() {
        ...
        let expected = vec![
            goblin_domain::FileStatus::new(
                ...
                goblin_domain::SyncStatus::InSync,
            ),
            goblin_domain::FileStatus::new(
                "/workspace/b.rs".to_string(),
                goblin_domain::SyncStatus::Modified,
            ),
            goblin_domain::FileStatus::new(
                "/workspace/c.rs".to_string(),
                goblin_domain::SyncStatus::Deleted,
            ),
            goblin_domain::FileStatus::new(
                "/workspace/d.rs".to_string(),
                goblin_domain::SyncStatus::New,
            ),
        ];
