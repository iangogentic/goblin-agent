...
use goblin_domain::{ChatResponseContent, Environment, TitleFormat};
...
mod tests {
    ...
    use goblin_display::DiffFormat;
    use goblin_domain::{ChatResponseContent, Environment, FileInfo};
    ...
    fn test_fs_create_with_warning() {
        ...
        let fixture = ToolOperation::FsWrite {
            ...
            output: FsWriteOutput {
                ...
                before: None,
                errors: vec![goblin_domain::SyntaxError {
                    line: 5,
                    column: 10,
    ...
    fn test_fs_remove() {
        let fixture = ToolOperation::FsRemove {
            input: goblin_domain::FSRemove { path: "/home/user/project/file.txt".to_string() },
    ...
    fn test_fs_undo() {
        let fixture = ToolOperation::FsUndo {
            input: goblin_domain::FSUndo { path: "/home/user/project/test.txt".to_string() },
            output: FsUndoOutput {
    ...
    fn test_plan_create() {
        let fixture = ToolOperation::PlanCreate {
            input: goblin_domain::PlanCreate {
        ...
        if let Some(ChatResponseContent::ToolInput(title)) = actual {
            ...
            assert_eq!(title.category, goblin_domain::Category::Debug);
