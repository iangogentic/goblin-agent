use goblin_domain::{ContextSummary, Role, SummaryMessage, SummaryTool, Transformer};
...
enum Operation<'a> {
    ...
    CodebaseSearch {
        queries: &'a [goblin_domain::SearchQuery],
    },
...
#[cfg(test)]
mod tests {
    use goblin_domain::{Role, SummaryBlock, SummaryToolCall, ToolCallId};
